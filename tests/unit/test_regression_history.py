...
from regression.history import load_failed_testsuites
from regression.history import write_failed_testsuites
from regression.history import _get_persistence
...
class TestLoadAndWriteFailedTestsuites(TestCase):
    ...
    def test_write_failed_testsuites_empty_list(self):
        suites = list()
        with patch('regression.history._get_persistence',
