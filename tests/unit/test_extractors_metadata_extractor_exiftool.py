...
class TestIsBadMetadata(TestCase):
    ...
    def test_bad_tags_values_return_true(self):
        ...
        self._assert_bad('XMP:Creator', 'author unknown')
        self._assert_bad('XMP:Creator', 'Author')
        self._assert_bad('XMP:Creator', 'Creator')
        self._assert_bad('XMP:Creator', 'CreatorAddress')
        self._assert_bad('XMP:Creator', 'CreatorBuildNumber')
        self._assert_bad('XMP:Creator', 'CreatorBuildNumber2')
        self._assert_bad('XMP:Creator', 'CreatorCity')
        self._assert_bad('XMP:Creator', 'CreatorCreatorIdentifierId')
        self._assert_bad('XMP:Creator', 'CreatorCreatorLanguage')
        self._assert_bad('XMP:Creator', 'CreatorFile-as')
        self._assert_bad('XMP:Creator', 'CreatorId')
        self._assert_bad('XMP:Creator', 'CreatorMajorVersion')
        self._assert_bad('XMP:Creator', 'CreatorMinorVersion')
        self._assert_bad('XMP:Creator', 'CreatorPostalCode')
        self._assert_bad('XMP:Creator', 'CreatorRegion')
        self._assert_bad('XMP:Creator', 'CreatorRole')
        self._assert_bad('XMP:Creator', 'CreatorSoftware')
        self._assert_bad('XMP:Creator', 'CreatorTool')
        self._assert_bad('XMP:Creator', 'CreatorVersion')
        self._assert_bad('XMP:Creator', 'CreatorXmlns')
        self._assert_bad('XMP:Creator', 'First Edition')
        self._assert_bad('XMP:Creator', 'I am the Author')
        self._assert_bad('XMP:Creator', 'MetadataCreator')
        self._assert_bad('XMP:Creator', 'MetadataCreatorFile-as')
        self._assert_bad('XMP:Creator', 'MetadataCreatorRole')
        self._assert_bad('XMP:Creator', 'PackageMetadataCreator')
        self._assert_bad('XMP:Creator', 'PackageMetadataCreatorRole')
        self._assert_bad('XMP:Creator', 'Private')
        self._assert_bad('XMP:Creator', 'Profile_creator')
        self._assert_bad('XMP:Creator', 'Profile_creator_version')
        self._assert_bad('XMP:Creator', 'ProfileCreator')
        ...
        self._assert_bad('XMP:Creator', 'User')
        self._assert_bad('XMP:Creator', 'user')
        self._assert_bad('XMP:CreatorTool', '()')
    ...
    def test_certain_bad_values_return_true_for_any_tag(self):
        ...
        self._assert_bad_any_tag('-|-  this layout: dynstabx  -|-')
        self._assert_bad_any_tag('-|-  this layout: pidus  -|-')
        self._assert_bad_any_tag('.'),
        ...
        self._assert_bad_any_tag('www.ebook3000.com')
