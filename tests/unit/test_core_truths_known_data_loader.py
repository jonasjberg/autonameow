...
class TestKnownDataFileParser(TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.SECTION_MATCH_ANY_LITERAL_CASESENSITIVE = KnownDataFileParser.SECTION_MATCH_ANY_LITERAL_CASESENSITIVE
        cls.SECTION_MATCH_ANY_LITERAL_IGNORECASE = KnownDataFileParser.SECTION_MATCH_ANY_LITERAL_IGNORECASE
        cls.SECTION_MATCH_ANY_REGEX_IGNORECASE = KnownDataFileParser.SECTION_MATCH_ANY_REGEX_IGNORECASE
        cls.SECTION_MATCH_ANY_REGEX_CASESENSITIVE = KnownDataFileParser.SECTION_MATCH_ANY_REGEX_CASESENSITIVE
