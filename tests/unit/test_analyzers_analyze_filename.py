...
class TestLikelyExtension(TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.expect_testinput = [
            ...
            (Expect('7z'), Given(suffix='7z',
                                 mime='application/x-7z-compressed')),
            (Expect('alfredworkflow'), Given(suffix='alfredworkflow',
                                             mime='application/zip')),
            (Expect('azw3'), Given(suffix='azw3',
                                   mime='application/octet-stream')),
            (Expect('bibtex'), Given(suffix='bibtex', mime='text/plain')),
            (Expect('bin'), Given(suffix='bin',
                                  mime='application/octet-stream')),
            (Expect('bz2'), Given(suffix='bz2', mime='application/x-bzip2')),
            ...
            (Expect('doc'), Given(suffix='doc', mime='application/msword')),
            (Expect('eps'), Given(suffix='eps', mime='application/postscript')),
            (Expect('hex'), Given(suffix='hex',
                                  mime='application/octet-stream')),
            (Expect('html.gz'), Given(suffix='htm.gz', mime='text/html')),
            (Expect('html.gz'), Given(suffix='html.gz', mime='text/html')),
            (Expect('log'), Given(suffix='log', mime='text/x-tex')),
            (Expect('mid'), Given(suffix='mid', mime='audio/midi')),
            ...
            (Expect('pdf'), Given(suffix='pdf',
                                  mime='application/octet-stream')),
            (Expect('ps'), Given(suffix='ps', mime='application/postscript')),
            ...
            (Expect('sln'), Given(suffix='sln',
                                  mime='application/octet-stream')),
            (Expect('tar.bz2'), Given(suffix='tar.bz2',
                                      mime='application/x-bzip2')),
            (Expect('tar.gz'), Given(suffix='tgz', mime='application/x-gzip')),
            (Expect('tar.gz'), Given(suffix='tar.gz',
                                     mime='application/x-gzip')),
            (Expect('tar.gz.sig'), Given(suffix='tar.gz.sig',
                                         mime='application/octet-stream')),
            (Expect('tex'), Given(suffix='tex', mime='text/x-tex')),
            (Expect('tex'), Given(suffix='tex', mime='application/x-tex')),
            (Expect('txt'), Given(suffix='txt', mime='text/plain')),
            (Expect('txt'), Given(suffix='txt',
                                  mime='application/octet-stream')),
            (Expect('txt.gz'), Given(suffix='txt.gz',
                                     mime='application/x-gzip')),
