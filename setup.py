...
setup(
    ...
    package_data={
        'autonameow': [
            ...
            'extractors/text/epub_fieldmeta.yaml',
            'extractors/text/markdown_fieldmeta.yaml',
            'extractors/text/pdf_fieldmeta.yaml',
            'extractors/text/plain_fieldmeta.yaml',
            'extractors/text/rtf_fieldmeta.yaml',
            'extractors/text/tesseractocr_fieldmeta.yaml',
